...
use App\Http\Controllers\NikaFrontendController;
...
// nika frontend
Route::get('abouts', [NikaFrontendController::class, 'abouts'])->name('abouts');
Route::get('contacts', [NikaFrontendController::class, 'contacts'])->name('contacts');
Route::get('pricings', [NikaFrontendController::class, 'pricings'])->name('pricings');
Route::get('our/blogs', [NikaFrontendController::class, 'our_blogs'])->name('our.blogs');
Route::get('our/gallerys', [NikaFrontendController::class, 'our_gallerys'])->name('our.gallerys');
